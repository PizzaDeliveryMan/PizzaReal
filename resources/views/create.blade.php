              ...
              <div class="col-lg-12">
                <form method="post" action="{{ route('user.orders.store') }}" class="form-horizontal">
                  ...
                  <div class="form-group"><label class="col-sm-2 control-label">Size</label>
                    ...
                    <div class="col-sm-10">
                      <div><label> <input type="radio" checked="" value="medium" id="medium" name="size"> Medium
                        </label></div>
                      <div><label> <input type="radio" value="large" id="large" name="size"> Large </label></div>
                      <div><label> <input type="radio" value="extra-large" id="extra-large" name="size"> Extra Large
                        </label></div>
                    </div>
                  </div>
                  ...
                  <div class="form-group"><label class="col-sm-2 control-label">Instructions</label>
                    ...
                    <div class="col-sm-10"><input type="text" name="instructions"
                                                  placeholder="Special Instructions here" class="form-control"></div>
                  </div>
